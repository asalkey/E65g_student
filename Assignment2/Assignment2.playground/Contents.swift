...
/*
     Allows you to pass an argument without a label.
 */
/*:
...
/*
    The transform variable has a type of (Int, Int) -> T.
 */
/*:
...
/*
    map2 will return an array of array of T.
 */
...
/*
   of is the external name when you envoke the neighbors you reference of.
 */
/*:
...
/*
  to is the internal name, inside of the function neighbors you reference to.
 */
...
extension Grid {
    ...
    func neighbors(of cell: Cell) -> [Position] {
        return Grid.offsets.map {
            ...
            let rowOffset = (($0 + cell.position.0 + rows) % rows)
            let colOffset = (($1 + cell.position.1 + cols) % cols)
...
/*
  I expect the combine argument to combine subtotal,row,and col then return an Int.
 */
/*:
...
/*
    The transform function was using T to return an array of an array while this function is using Int.
 */
...
/*
 We are using a 10x10 grid which equals 100 with the probablity of 1/3 alive cells that would equal to 33 but arc4random_uniform returns a random number within bounds.
...
/*
  Cell is an inherit type while self[row,col] is called by a method and returns an optional cell.
 */
/*:
...
/*
  The closure is first called with cell of 0 and the first element of neighbors returning 1. It then loops through the closure with the previous return value and first element of the sequence until it ends.
 */
...
/*
  It represents the next state of cells
 */
/*:
 ## Problem 22:
